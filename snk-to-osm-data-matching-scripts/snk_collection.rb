class SnkCollection
  ...
  def osm_of_all_amenity_libraries
    puts "fetching all amenity:library osm data"
    osm = execute_overpass_query overpass_query_to_find_all_amenity_libraries
    return osm
  end
