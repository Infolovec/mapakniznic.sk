mapaKniznicApp.service('libraryIcons', function() {
  var service = {}

  service.getImage = function(libraryType, color){
    ...
    var iconImgFn = libraryTypeToImg[libraryType]
    if(iconImgFn == null)
      iconImgFn = this._libraryBuildingImg

    var iconImg = iconImgFn.call(null, color)
    return iconImg.replace(/\#/g, '%23')
  }

  service._libraryBuildingImg = function(color){
  ...
  service._summerReadImg = function(color){
  ...
  service._biblioboxImg = function(color){
  ...
  service._bookBoxImg = function(color){
